...
impl Item1_ for Item_ {
	fn hello2__(&self, env:&code_::Env_, wm:&mut WorldMut_, ret:&mut result_::List_) -> Result2_ {
		t_::o__(&self.a_).hello__(env, wm, ret)
	}
}
...
impl Item1_ for SimpItem_ {
	fn hello2__(&self, _env:&code_::Env_, _wm:&mut WorldMut_, ret:&mut result_::List_) -> Result2_ {
